...
jQuery(function($) {
        ...
        top_menu_height = $('.werewolf-top-menu').height();
        // scroll spy to auto active the nav item
        $('body').scrollspy({ target: '#werewolf-nav-bar', offset: top_menu_height + 10 });
		$('.external-link').unbind('click');

        // scroll to top
        $('#btn-back-to-top').click(function(e){
            e.preventDefault();
            scrollTo('#werewolf-top');
        });

        // scroll to specific id when click on menu
        $('.werewolf-top-menu .navbar-nav a').click(function(e){
            e.preventDefault(); 
		...
		*/
        ...
        $('.werewolf-top-menu ').stickUp();

        // gallery category
        $('.werewolf-gallery-category a').click(function(e){
            e.preventDefault(); 
